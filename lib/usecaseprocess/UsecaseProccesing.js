...
module.exports = {
    ...
    wordCallback: function (simwordcallsIns, similarWordsList, wordId, posTagMapping) {
        ...
        for (var t in similarWordsList) {
            if (t==0) var type = "synonym";
            if (t==1) var type = "hypernym";
            if (t==2) var type = "hyponym";
            simwordcallsIns.push(inserts.insertSimilarwordsIntoWords(similarWordsList[t], wordId, posTagMapping, type));
        }
    },
